  ...
  return (
    <>
      <Form
        ...
        valueConfigurationTwo="/tmp"
        valueConfigurationThree="/export/home"
        valueConfigurationFour="CPU"
        icConfigurationOne="/"
        icConfigurationTwo="/tmp"
        icConfigurationThree="/export/home"
        icConfigurationFour="CPU"
        ...
        valueMajorOne=">=80%"
        valueMajorTwo=">80%=60min."
        majorOne=">=80%"
        majorTwo=">80%=60min."
        valueCritical={info.critical}
        valueCriticalOne=">=90%"
        valueCriticalTwo=">90%=60min."
        criticalOne=">=90%"
        criticalTwo=">90%=60min."
