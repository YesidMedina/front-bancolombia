  ...
  return (
    <>
      <Form
        ...
        valueRolTwo="Base de Datos"
        valueRolThree="Panoramica_Cliente"
        rolOne="Plataforma Windows-Linux Bancolombia"
        rolTwo="Base de Datos"
        rolThree="Panoramica_Cliente"
        valuesNameDevice={info.name_device}
        valueIp={info.ip_divice}
        valueBaseline="Windows"
        baseline="Windows"
        valueItemConfiguration={info.item_configuration}
        valueItemConfigurationOne="%Utilizacion"
        valueItemConfigurationTwo="Disponibilidad"
        valueItemConfigurationThree="Busy"
        itemConfigurationOne="%Utilizacion"
        itemConfigurationTwo="Disponibilidad"
        itemConfigurationThree="Busy"
        ValueIcConfiguration={info.ic_configuration}
        valueConfigurationOne="Memoria Física"
        valueConfigurationTwo="CPU"
        valueConfigurationThree="Disco Lógico"
        valueConfigurationFour="Watch-Memoria-"       
        icConfigurationOne="Memoria Física"
        icConfigurationTwo="CPU"
        icConfigurationThree="Disco Lógico"
        icConfigurationFour="Watch-Memoria-"
        ...
        valueMajorTwo=">90%=30min."
        valueMajorThree=">28GB"
        valueMajorFour=">85%=30min."
        valueMajorFive="N/A"
        majorOne=">80%=60min."
        majorTwo=">90%=30min."
        majorThree=">28GB"
