  ...
  return (
    <>
      <div className="sm:-mt-12 sm:flex sm:justify-center">
        ...
        <p className="text-xs">
          Los campos en rojo son obligatorios y seleccionables de linea base
        </p>
      </div>
              ...
              <div>
                ...
                <div className="bg-red-200 relative mb-4">
                  ...
                  >
                    ...
                    <option value="Transformacion Informacion LZ">
                      Transformacion Informacion LZ
                    </option>
                  </select>
                </div>
                <div className="relative mb-4">
                ...
                <div className="bg-red-200 relative mb-4">
                  ...
                  >
                    ...
                    <option value="Memoria Swap">Memoria Swap</option>
                  </select>
                </div>
              ...
              <div>
                ...
                <div className="bg-red-200 relative mb-4">
                  ...
                  >
                    ...
                    <option value=">80%=120min.">&gt;80%=120min.</option>
                    <option value=">=80%">&gt;=80%</option>
                    <option value=">28GB">&gt;28GB</option>
                    <option value=">5%=30min.">&gt;5%=30min.</option>
                  </select>
                </div>
